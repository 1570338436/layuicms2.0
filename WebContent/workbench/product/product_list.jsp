...
<script>
	...
	$(function(){
		...
		layer.open({
				  ...
				  fixed: false, //不固定
				  maxmin: true,
				  content: 'workbench/product/iframe.html'
				}); 
...
<section>
 <div class="rt_content">
      <div class="page_title">
       ...
       <a href="workbench/product/product_detail.jsp" class="fr top_rt_btn add_icon">添加商品</a>
      </div>
      <section class="mtb">
       <select class="select">
        <option>下拉菜单</option>
       ...
       <input type="button" id="query" value="查询" class="group_btn"/>
      </section>
      <table class="table">
       <tr>
        <th>缩略图</th>
